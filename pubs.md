...
3. **Learning from Label Proportions: Bootstrapping Supervised Learners via Belief Propagation**
...
4. **Improving Fairness-Accuracy tradeoff with few Test Samples under Covariate Shift**
...
5. **Label Differential Privacy via Aggregation**

   Brahmbhatt, A., Saket, R., **Havaldar, S.**, Nasery, A., & Raghuveer, A.
   
   [[Paper]](https://arxiv.org/abs/2310.10092) (under submission at **TMLR**)

6. **On the Benefits of Defining Vicinal Distributions in Latent Space**
